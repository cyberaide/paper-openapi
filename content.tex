...
\COMMENT{~\cite{nist-v1,nist-v2,nist-v3,nist-v4,nist-v5,nist-v6,nist-v7,nist-v8,nist-v9}.}
~\cite{nist-v1,nist-v2,nist-v3,nist-v4,nist-v5,nist-v6,nist-v7,nist-v9}}.
...
\caption{NIST Big Data Reference Architecture}
...
provider access instead of REST services. \COMMENT{The
...
\BLOCKCENSOR{This section has been remved to avoid that identification can be achieved by elimination and comparison comments. This also includes refernces.}
